test_prg: test_prg.cpp libmap.a goldchase.h serverdaemon.cpp clientdaemon.cpp
	g++ -g test_prg.cpp serverdaemon.cpp clientdaemon.cpp -o test_prg -L. -lmap -lpanel -lncurses -lrt -lpthread
